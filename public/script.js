(function(){
  ...
  const els = {
    ...
    professora:
      document.getElementById('professora'),

    turma:
      document.getElementById('turma'),

    periodoManha:
      document.getElementById('periodo-manha'),

    periodoTarde:
      document.getElementById('periodo-tarde')
  };
  ...
  /* ========================================
     API - CARREGAR PLANEJAMENTO DA SEMANA
     ======================================== */

  async function carregarSemanaAPI(
    semana
  ) {
  ...
  async function excluirBlocoAPI(
    semana,
    dia,
    blocoId
  ) {
  ...
  /* ========================================
     SALVAR TODOS OS BLOCOS DA SEMANA
     ======================================== */
  ...
  function renderWeek(
    ...
    fridayDate.setUTCDate(
      monday.getUTCDate() + 4
    );

    els.rangeLabel.textContent =
      `${fmtDate(monday)} a ${fmtDate(fridayDate)}`;
    ...
    DAYS.forEach(
      (day, idx) => {
        ...
        dateForDay.setUTCDate(
          monday.getUTCDate() + idx
        );
  ...
  /* ========================================
     RENDERIZAR UM BLOCO DE HORÁRIO
     ======================================== */
  ...
  function renderBlock(
    ...
    el.innerHTML = `
      ...
      <div class="local-wrap">
        ...
        <input
          class="local-badge-input"
          list="dl-locais"
          placeholder="LOCAL / DESTAQUE (ex: PARQUE)"
          value="${escapeHtml(block.local || '')}"
        >
      ...
      <textarea
        class="block-text"
        placeholder="Escreva aqui (tema, observações)..."
      >${escapeHtml(block.texto || '')}</textarea>
    ...
    /* ========================================
       RENDERIZAR PROPOSTAS / ATIVIDADES
       ======================================== */
    ...
    try {
      ...
      if (
        ...
        usuarioLogado.textContent =
          `${dados.usuario.nome} • ${dados.usuario.perfil}`;
  ...
  /* ========================================
     EVENTO ENTER NO CAMPO DE E-MAIL
     ======================================== */
